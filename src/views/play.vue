<template>
    <div class="post">
        ...
        <h1>Play</h1>
            ...
            activity, every kind of game, puzzle, and toy are forms of play. It
            is not merely an activity for <i>"enjoyment"</i> or <i>"recreation,"
                and it is absolutely not exclusive to children.</i> </p>
            <p>
            ...
            <p>
            Play is
            another instinct that has a significant function that we cannot find
            a biological basis to justify.
            ...
            <ul>
                <li>Play is a result of a need for <i>relaxation</i>.</li>
                <li>Play is a discharge of an abundant vital energy.</li>
                <li>Play is a method that trains young animals for serious life situation</li>
                <li>Play is a “wish-fulfillment” activity.</li>
                <li>Play is an activity that satisfies the natural need for dominance and competition in a non-harmful environment</li>
            </ul>
            <p>All of these hypotheses share four common flaws:
            </p>
            <ul>
                <li>They are narrow.</li>
                <li>They start with the assumption that play must serve one particular biological function.</li>
                <li>Play is considered without its profoundly aesthetic
                    properties.</li>
                <li>Play is thought of as a rational activity.</p></li>
            ...
            life, and thus, its foundation cannot be discovered in a rational
            nexus.
            </p>
            <p>
            ...
            <ul>
                <li>Play is not the opposite of seriousness, consider
                    soccer.</li>
                <li>Play is not for children, consider gambling.</li>
                <li>Play is not rudimentary, senseless, artificial, pretentious
                    or man-made.</li>
            </ul>
            <h3>We are <i>Homo</i> Ludens</h3>
            <p>
            ...
            name our species <i>Homo. sapiens</i>, Man the Rational.
            ...
            <p>
            We inclined to designate our species as <i>Homo Faber</i>, Man the
            ...
            Johan Huizinga suggested <i>Homo ludens</i>, Man, the Player.
            Linguistically, the latin word Ludens is more involved than "play,"
            it may refer to School, Practice and Sports.
            </p>
            <h3>Other names for Homo Sapiens</h3>
            <ul>
                <li><b><i>Homo adorans</i></b>, Man the Worshiper: too narrow</li>
                <li><b><i>Homo amans</i></b>, Man the Lover: too narrow</li>
                <li><b><i>Homo combinans</i></b>, The Combining Man: We counted
                passed inifinity.</li>
                <li><b><i>Homo avers</i></b>, Man the Greedy: Sadistic</li>
            </ul>
