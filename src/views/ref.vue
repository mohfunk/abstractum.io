<template>
    <div class="post">
        <div class="text">
            ...
            <p>
            The foreign minister of Canada tweeted to destroy me; I wouldn't have imagined how a tweet could undo the last four years of my life. I was furious, and I clearly expressed that; only to see that
            I was not allowed to show anything but complete obedience to my king, and admiration for my wise crown prince. I frankly was too concerned about my future to follow orders blindly, but how can I be assured when my father turned against me? When my friends are bothered by me? Instead of reassuring me, my people refused to talk to me, some attacked me, and many criminalized me!
            </p>
            <p>
            I was deeply bothered to find myself dragged into politics, so I turned to the media, I saw ignorance and false claims about people I
            loved. The Saudi Media was too busy lying about Canada while praising the wisdom and might of the crown prince. I was looking for a voice to remind me of the welcoming warmth of my people, to find one among many that terrorized me. A Saudi "Vlogger" promised students severe punishment if they complain or disobey. The prince will kidnap, torture and silence you like he did with many before.
            I felt dehumanized, and I genuinely feared my country.
            </p>
            <p>
...
<script>
import arabic from '../components/artext.vue';
export default {
    name: 'ppost',
    components: {
        arabic
